...
import { getNotSendedEmails } from '../api/api';
import {
    ...
    return (
        <Box sx={{ bgcolor: '#f7f8fa', minHeight: '100vh', py: 4 }}>
            <Box sx={{ maxWidth: 1200, mx: 'auto', px: 2 }}>
                <Typography variant="h5" fontWeight={700} mb={0.5} color="#222">Not Sended Emails</Typography>
                <Typography variant="body1" color="#888" mb={3}>Emails that could not be sent yet.</Typography>
                {/* Search Bar */}
